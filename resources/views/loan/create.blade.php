            ...
            <div class="form-group" id="clients_div" style="display: none">
                ...
                <div class="col-md-5">
                    <select name="client_id" class="form-control select2" id="client_id">
                        <option></option>
                        @foreach(\App\Models\Client::where('status', 'active')->where('office_id',$branch)->get() as $key)
                            <option value="{{$key->id}}">
            ...
            <div class="form-group" id="groups_div" style="display: none">
                ...
                <div class="col-md-5">
                    <select name="group_id" class="form-control select2" id="group_id">
                        <option></option>
                        @foreach(\App\Models\Group::where('status', 'active')->where('office_id',$branch)->get() as $key)
                            <option value="{{$key->id}}">
