        ...
        <div class="box box-white">
            <div class="box-body ">
                <div class="table-responsive">
                    <form>
                <button style="margin-bottom: 10px" class="btn btn-primary delete_all" data-url="{{ url('journal/del') }}">Delete All Selected</button>
                    <table id="data-table" class="table table-striped table-condensed table-hover">
                        ...
                        @foreach($data as $key)
                            <tr>
                                <td>
                                <label>
                                        <input type="checkbox" class="" name="delid[]" value="{{ $key->id }}"
                                               id="chk_id">
                                    </label>
                                </td>
                                <td>{{ $key->id }}</td>
