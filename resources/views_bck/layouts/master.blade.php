...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="pull-right m-9 col-md-13 mt-15" style="color: #fff;"></div>
          ...
          data-href="">
            ...
            <div class="col-md-3">
           <ul class="nav navbar-nav">
           <button type="button" id="register_details" title="#" data-toggle="tooltip" data-placement="bottom" class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10 btn-modal" data-container=".register_details_modal" 
          data-href="#">
           ...
           <div class="col-md-3">
            ...
            <button id="btnCalculator" title="{{trans_choice('general.calculator',1)}}" type="button" class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10 popover-default" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
