...
@section('title')
    {{trans_choice('general.clients',1)}} {{trans_choice('general.report',1)}}
@endsection
@section('content')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li>
                                    <a href="{{url('report/client_report/client_listing/excel?end_date='.$end_date.'&office_id='.$office_id)}}"
                                       target="_blank"><i
                                                class="icon-file-excel"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.excel',1)}}
                                    </a></li>
                                <li>
                                    <a href="{{url('report/client_report/client_listing/csv?end_date='.$end_date.'&office_id='.$office_id)}}"
                                       target="_blank"><i
                ...
                <table class="table table-condensed table-hover " style="font-size: 12px">
                    ...
                    <tr style="height: 25pt">
                        <td colspan="19" valign="middle"
                            class="style-1"> {{trans_choice('general.clients',1)}}  {{trans_choice('general.report',1)}}</td>
                    </tr>
