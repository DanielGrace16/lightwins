                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-right btn-group">
                                    ...
                                    @if(Sentinel::hasAccess('loans.update'))
                                        <a href="#"
                                           data-toggle="modal" data-target="#refund_modal"
                                           class="btn btn-primary"><i
                                                    class="fa fa-money"></i>&nbsp;
                                           Refund
                                        </a>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            ...
                                            <li>
                                                <a href="{{ url('loan/'.$loan->id.'/statement') }}"
                                                   target="_blank">
                                                    {{ trans_choice('general.account',1) }} {{ trans_choice('general.statement',1) }} </a>
                                            </li>
                                        @endif
                                                ...
                                                @foreach(\App\Models\LoanTransaction::where('loan_id',$loan->id)->whereIn('reversal_type',['user','none'])->orderBy('date','asc')->orderBy('id','asc')->get() as $key)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif
                                                            @if($key->transaction_type=='refund')
                                                                Refund
                                                            @endif
                                                            ...
                                                            @endif
                                                            @if($key->transaction_type=='batch_transfer')
                                                                {{trans_choice('general.transfer',1)}} {{trans_choice('general.repayment',1)}}
                                                            @endif
                                                            @if($key->reversed==1)
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="{{url('loan/'.$loan->id.'/refund/store')}}"
                                          class="form-horizontal "
                                          enctype="multipart/form-data" id="refund_form">
                                        {{csrf_field()}}
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="charge_notes"
                                                       class="control-label col-md-3">Source Fund</label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="charge_id" class="select2 form-control"
                                                        ...
                                                        <option></option>
                                                        @foreach(\App\Models\Charge::where('active', 1)->where('product', "loan")->get() as $key)
                                                        <option value="{{$key->id}}">{{$key->name}}</option>
                                                @endforeach
